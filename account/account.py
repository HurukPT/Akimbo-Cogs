...
class Account(commands.Cog):
    ...
    async def about(self, ctx, *, about):
        ...
        if len(about) > 1024:
            data = discord.Embed(colour=user.colour)
            data.add_field(
                name="Error:warning:", value="Your about section is too long. Please make it less than 1024 characters.")
            await ctx.send(embed=data)
            ...
            data = discord.Embed(colour=user.colour)
            data.add_field(name="Congrats!:sparkles:",
                           value="You have updated your About Me to {}".format(about))
            await ctx.send(embed=data)
    ...
    async def website(self, ctx, *, site):
        ...
        if len(site) > 1024:
            data = discord.Embed(colour=user.colour)
            data.add_field(
                name="Error:warning:", value="Your website is too long. Please make it less than 1024 characters.")
            await ctx.send(embed=data)
            ...
            data = discord.Embed(colour=user.colour)
            data.add_field(name="Congrats!:sparkles:",
                           value="You have set your Website to {}".format(site))
            await ctx.send(embed=data)
    ...
    async def age(self, ctx, *, age):
        ...
        if len(age) > 1024:
            data = discord.Embed(colour=user.colour)
            data.add_field(
                name="Error:warning:", value="Your age is too long. Please make it less than 1024 characters.")
            await ctx.send(embed=data)
            ...
            data = discord.Embed(colour=user.colour)
            data.add_field(name="Congrats!:sparkles:",
                           value="You have set your age to {}".format(age))
            await ctx.send(embed=data)
    ...
    async def job(self, ctx, *, job):
        ...
        if len(job) > 1024:
            data = discord.Embed(colour=user.colour)
            data.add_field(
                name="Error:warning:", value="Your job is too long. Please make it less than 1024 characters.")
            await ctx.send(embed=data)
            ...
            data = discord.Embed(colour=user.colour)
            data.add_field(name="Congrats!:sparkles:",
                           value="You have set your Job to {}".format(job))
            await ctx.send(embed=data)
    ...
    async def gender(self, ctx, *, gender):
        ...
        if len(gender) > 1024:
            data = discord.Embed(colour=user.colour)
            data.add_field(
                name="Error:warning:", value="Your gender is too long. Please make it less than 1024 characters.")
            await ctx.send(embed=data)
            ...
            data = discord.Embed(colour=user.colour)
            data.add_field(name="Congrats!:sparkles:",
                           value="You have set your Gender to {}".format(gender))
            await ctx.send(embed=data)
    ...
    async def email(self, ctx, *, email):
        ...
        if len(email) > 1024:
            data = discord.Embed(colour=user.colour)
            data.add_field(
                name="Error:warning:", value="Your email is too long. Please make it less than 1024 characters.")
            await ctx.send(embed=data)
            ...
            data = discord.Embed(colour=user.colour)
            data.add_field(name="Congrats!:sparkles:",
                           value="You have set your Email to {}".format(email))
            await ctx.send(embed=data)
    ...
    async def other(self, ctx, *, other):
        ...
        if len(other) > 1024:
            data = discord.Embed(colour=user.colour)
            data.add_field(
                name="Error:warning:", value="Your other is too long. Please make it less than 1024 characters.")
            await ctx.send(embed=data)
            ...
            data = discord.Embed(colour=user.colour)
            data.add_field(name="Congrats!:sparkles:",
                           value="You have set your Other to {}".format(other))
            await ctx.send(embed=data)
    ...
    async def characterpic(self, ctx, *, characterpic):
        ...
        if user.id not in db:
            ...
            data = discord.Embed(colour=user.colour)
            data.add_field(name="Congrats!:sparkles:",
                           value="You have set your characterpic to {}".format(characterpic))
        ...
        if user.id not in db:
            ...
            if(len(new_spell_list_invalid) > 0):
                ...
                data.add_field(name="Oh no!:warning:",
                               value="The following spells are not a valid:\n{}}".format("".join(map(str, new_spell_list_invalid))))
                data.add_field(
            ...
            if category.upper() in map(str.upper, Fields):
                ...
                if category == "Spell":
                    if value.upper() in map(str.upper, userdata[category]):
                        ...
                        data = discord.Embed(colour=user.colour)
                        data.add_field(
                            name="Congrats!:sparkles:", value="You have removed {} from your {}".format(value, category))
                        await ctx.send(embed=data)
                    else:
